...
export type ManagementIconName = 'dashboard' | 'clients' | 'documents' | 'folder' | 'calendar' | 'settings' | 'duplicate' | 'mail' | 'whatsapp' | 'phone' | 'note' | 'download' | 'upload' | 'logout' | 'plus' | 'search' | 'edit' | 'trash' | 'menu' | 'x' | 'arrow' | 'print' | 'shield' | 'warehouse' | 'truck'
...
const paths: Record<ManagementIconName, React.ReactNode> = {
  ...
  settings: <><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.83 2.83-.06-.06a1.7 1.7 0 0 0-1.88-.34 1.7 1.7 0 0 0-1.03 1.56V21h-4v-.09A1.7 1.7 0 0 0 9 19.36a1.7 1.7 0 0 0-1.88.34l-.06.06-2.83-2.83.06-.06A1.7 1.7 0 0 0 4.63 15 1.7 1.7 0 0 0 3.07 14H3v-4h.09A1.7 1.7 0 0 0 4.64 9 1.7 1.7 0 0 0 4.3 7.12l-.06-.06 2.83-2.83.06.06A1.7 1.7 0 0 0 9 4.63 1.7 1.7 0 0 0 10 3.07V3h4v.09A1.7 1.7 0 0 0 15 4.64a1.7 1.7 0 0 0 1.88-.34l.06-.06 2.83 2.83-.06.06A1.7 1.7 0 0 0 19.37 9 1.7 1.7 0 0 0 20.93 10H21v4h-.09A1.7 1.7 0 0 0 19.4 15z"/></>,
  duplicate: <><rect x="8" y="8" width="12" height="12" rx="2"/><path d="M16 8V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h3"/></>,
  mail: <><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></>,
  whatsapp: <><path d="M20.5 11.7a8.5 8.5 0 0 1-12.6 7.4L3 20.5l1.4-4.7a8.5 8.5 0 1 1 16.1-4.1z"/><path d="M8.2 7.7c.4 3.5 2.7 5.8 6.1 6.3l1.3-1.5-2.2-1-.8 1c-1.5-.6-2.5-1.6-3.1-3.1l1-.8-1-2.2z"/></>,
  ...
  warehouse: <><path d="m3 10 9-6 9 6v11H3z"/><path d="M7 21v-8h10v8M7 16h10M10 13v8M14 13v8"/></>,
